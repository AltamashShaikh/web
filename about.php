...
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=g1">
...
<body> 
		...
		<div class="container">	
			<div class="w3ls_about_grids">
				<div class="col-md-6 w3ls_about_grid_left">
					<p>E-commerce professional with over 3.5 years of versatile experience having proficient understanding of different components of E-commerce like CRM,Warehouse Operations.</p>
					<div class="col-xs-2 w3ls_about_grid_left1">
						<span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>
					</div>
					<div class="col-xs-10 w3ls_about_grid_left2">
						<p>Key Brands Handled: Soh,Globus,Vero Moda,Fab India,Only,Spartan Sports.</p>
					</div>
					<div class="clearfix"> </div>
					<div class="col-xs-2 w3ls_about_grid_left1">
					...
					<div class="col-xs-10 w3ls_about_grid_left2">
						<p>Professional Skills: Merchandising,Sales Forecasting,Stratergic Planning,Brand Management,Communication And Interpersonal Skills.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
	...
	<div class="team">
		<div class="container">
			...
			<div class="wthree_team_grids">
				...
				<div class="clearfix"> </div>
				<p>A Market palce that combines online shopping with offline store experience,to serve million customers.</p>
			</div>
		</div>
	</div>
	<!-- //team -->
	...
	<div class="team-bottom">
		<div class="container">
			...
			<p>EMI Starting at just RS.460.Whom are you waiting for???.Don't miss it.Grab the opportunity.</p>
			<a href="mobile.php">Shop Now</a>
		</div>
	</div>
	<!-- //team-bottom -->
	<!-- newsletter -->
